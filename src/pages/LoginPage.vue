        ...
        <div class="login-container">
          ...
          <div class="left-panel gt-sm">
            ...
            <div class="left-content">
              ...
              <div class="left-sub">
                Gestiona todas tus cuentas, analiza tus gastos y alcanza tus metas financieras desde un solo lugar.
              </div>
            ...
            <div class="form-wrapper">
              ...
              <div class="lt-md text-center q-mb-xl">
                <div class="row items-center justify-center q-gutter-xs">
                  ...
                  <span class="text-weight-bold text-primary" style="font-size: 22px">MyFinances</span>
                </div>
              </div>
              ...
              <div class="divider-row q-my-lg">
                <div class="divider-line" />
                <span class="divider-text">{{ $t('auth.or_continue') }}</span>
                <div class="divider-line" />
              </div>

              <!-- Botones sociales -->
              <div class="row q-mb-lg">
                <q-btn outlined class="col social-btn" no-caps>
                  <svg width="18" height="18" viewBox="0 0 24 24" class="q-mr-sm" style="flex-shrink:0">
...
const features = [
  { icon: 'bar_chart',  title: 'Análisis Inteligente',  desc: 'Visualiza tus patrones de gasto y toma mejores decisiones' },
  { icon: 'autorenew',  title: 'Automatización Total',  desc: 'Olvídate de registrar gastos recurrentes manualmente' },
  { icon: 'lock',       title: '100% Seguro',            desc: 'Tus datos están protegidos con encriptación bancaria' },
]
